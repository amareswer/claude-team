import { isContentProject } from '../agent.js';
...
Agents append research requests to the \`messages\` array in your inbox:
\`\`\`json
{
  "from": "agent-name",
...
Then append to the \`messages\` array in the requesting agent's inbox:
\`\`\`json
{
  "from": "researcher",
