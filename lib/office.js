...
import { updateJson, writeJsonLocked } from './jsonStore.js';
 ...
 * (removed from the old assignee's inbox, delivered to the new one's).
 */
async function updateTask(id, { assignTo, cancel }) {
  ...
  // Pull the task out of the previous assignee's inbox so two agents never
  // hold the same work.
